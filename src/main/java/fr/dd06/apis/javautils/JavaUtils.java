...
package fr.dd06.apis.javautils;
...
public final class JavaUtils
{
    ...
    private static String resourcePathFX;

    private static String defaultresourcePathFX = "file:src";
    /**
    ...
    public static void setSystemLookNFeel()
    {
        ...
        {
            System.out.println("[JavaSwing] WARNING: Can't set the system look n feel : " + e);
        }
     ...
     *
     * @see JavaSwing#setResourcePath(String)
     */
    public static String getResourcePath()
    {
        return resourcePath;
    }
    public static String getResourcePathFX() {
    	return resourcePathFX;
    }
    ...
    {
        JavaUtils.resourcePath = resourcePath.endsWith("/") ? resourcePath.substring(0, resourcePath.length() - 1) : resourcePath;
    }
    public static void setResourcePathFX(String resourcePathFX) {
    	String finalPathFX;
    	if(!resourcePathFX.startsWith("/")) {
    		finalPathFX = defaultresourcePathFX + "/" + resourcePathFX;
    	}
    	else {
    		finalPathFX = defaultresourcePathFX + resourcePathFX;
    	}
    	if(!resourcePathFX.endsWith("/")) {
    		finalPathFX = finalPathFX + "/";
    	}
    	JavaUtils.resourcePathFX = finalPathFX;
    }
    ...
    public static BufferedImage getResource(String resource)
    {
        try
        {
            return ImageIO.read(JavaUtils.class.getResourceAsStream(getResourcePath() + "/" + resource));
        }
        catch (IOException e)
        {
    ...
    public static String getResourceFX(String resource) {

    	
    	return resourcePathFX + resource;
    }
    ...
    public static BufferedImage getResourceIgnorePath(String resource)
    {
        try
        {
            return ImageIO.read(JavaUtils.class.getResourceAsStream(resource));
        }
        catch (IOException e)
        {
